...
type DeviceServiceClient interface {
	GetDevice(ctx context.Context, in *empty.Empty, opts ...grpc.CallOption) (*Device, error)
}
...
func (c *deviceServiceClient) GetDevice(ctx context.Context, in *empty.Empty, opts ...grpc.CallOption) (*Device, error) {
	out := new(Device)
...
type DeviceServiceServer interface {
	GetDevice(context.Context, *empty.Empty) (*Device, error)
...
func (UnimplementedDeviceServiceServer) GetDevice(context.Context, *empty.Empty) (*Device, error) {
...
func _DeviceService_GetDevice_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(DeviceServiceServer).GetDevice(ctx, req.(*empty.Empty))
	}
